...
int testBuild(struct renderer *r) {
	...
	addMaterial(r->scene, newMaterial(colorWithValues(0.1, 0.1, 0.2, 0.0), 1.0)); //Matte blue
	...
	r->image->count = 0;
	r->image->size.width = 800;
	r->image->size.height = 600;
	...
	addLight(r->scene, newLight(vectorWithPos(1240, 350, 600), 200, colorWithValues(255.0, 0.0, 6.0, 0.0)));
	
	//addSphere(r->scene, newSphere(vectorWithPos(1210, 450, 1050), 50, 8)); //Green&red 8
	//addSphere(r->scene, newSphere(vectorWithPos(1240, 350, 600), 50, 10)); //Blue 10
	//addSphere(r->scene, newSphere(vectorWithPos(800, 600, 1300), 300, 8)); //Green&red 8
	//addSphere(r->scene, newSphere(vectorWithPos(600, 220, 1400), 50, 9)); //White 9

	addSphere(r->scene, newSphere(vectorWithPos(1100, 500, 1500), 75, 8)); //Green&red 8
	addSphere(r->scene, newSphere(vectorWithPos(1000, 220, 1400), 50, 10)); //Blue 10
	addSphere(r->scene, newSphere(vectorWithPos(800, 600, 1300), 300, 8)); //Green&red 8
	addSphere(r->scene, newSphere(vectorWithPos(600, 220, 1400), 50, 9)); //White 9
...
/*
  Candidate
  	addSphere(r->scene, newSphere(vectorWithPos(1100, 350, 1500), 75, 8)); //Green&red 8
	addSphere(r->scene, newSphere(vectorWithPos(1000, 220, 1400), 50, 10)); //Blue 10
	addSphere(r->scene, newSphere(vectorWithPos(800, 600, 1300), 300, 8)); //Green&red 8
	addSphere(r->scene, newSphere(vectorWithPos(600, 220, 1700), 50, 11)); //White 11
*/
